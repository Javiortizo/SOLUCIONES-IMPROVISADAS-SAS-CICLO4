...
export class EditarSucursalComponent implements OnInit {
  ...
  BuscarSucursal() {
    this.sucursalServicio.ObtenerRegistroPorId(this.id).subscribe((datos: ModeloSucursal) => {
  ...
  EditarSucursal() {
    ...
    this.sucursalServicio.ActualizarSucursal(s).subscribe((datos: ModeloSucursal) => {
